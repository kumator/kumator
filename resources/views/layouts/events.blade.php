                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-20">
                                    ...
                                    <div class="switch-field">
                                      <input type="radio" id="donateAmount500" name="donateAmount" checked>
                                      <label for="donateAmount0020">&#8358;500</label>
                                      <input type="radio" id="donateAmount1000" name="donateAmount">
                                      <label for="donateAmount0050">&#8358;1000</label>
                                            <input type="radio" id="donateAmount00100" name="donateAmount">
                                      <label for="donateAmount00100">&#8358;2000</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
